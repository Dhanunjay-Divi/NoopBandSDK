...
and categorized failure terminals. Connection and authentication progress,
completion, cancellation, and failure are generation-fenced and use bounded
diagnostics. Firmware uses a dedicated diagnostic family, and the recent
identity cache remains bounded. It does not contain or validate a supplier
transport.
